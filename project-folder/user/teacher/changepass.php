			...
			<div class="row">
				<div class="col-md-12">
					<form action="" class="pass-content" method="post">
						...
						<input type="password" class="form-control mt-10" name="cpassword"
					...
					if (isset($_POST["submit"])) {
						...
						if ($cpass != $pass) {
							...
							<div class="alert alert-warning">
								<strong style="color:#333">Invalid!</strong> <span style="color: red;font-weight: bold; ">You
									entered wrong password</span>
							</div>
							<?php
						} else {
							if ($npass == $conpass) {
								...
								<div class="alert alert-success">
									<strong style="color:#333">Success!</strong> <span style="color: green;font-weight: bold; ">Your
								...
								?>
								<div class="alert alert-warning">
									<strong style="color:#333">Not match!</strong> <span style="color: red;font-weight: bold; ">Your
										password</span>
								</div>
								<?php
							}
